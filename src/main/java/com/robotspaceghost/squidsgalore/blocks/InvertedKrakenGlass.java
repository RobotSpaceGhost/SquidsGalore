...
public class InvertedKrakenGlass extends Block {
    ...
    public InvertedKrakenGlass() {
        ...
        this.setDefaultState(this.getDefaultState().with(LIT, Boolean.TRUE).with(INDIRECT, Boolean.FALSE));
