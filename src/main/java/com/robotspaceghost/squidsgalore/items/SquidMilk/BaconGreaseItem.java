...
public class BaconGreaseItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.BACON_GREASE_EFFECT;
    public final int MILK_EFFECT_DURATION = 2 * 60 * 20 + 30 * 20; //may change
    public final int MILK_EFFECT_LEVEL = 0;
    public final boolean isLong;
    public final boolean isThick;


    public BaconGreaseItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public BaconGreaseItem(){
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(ITextComponent.func_241827_a_(TextFormatting.GRAY +"Technically an essential oil" ));
    }
}
