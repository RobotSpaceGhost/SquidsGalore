...
public class MinersDelightItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.MINERS_DELIGHT_EFFECT;
    ...
    public MinersDelightItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public MinersDelightItem(){
