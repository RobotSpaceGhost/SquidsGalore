...
public class FloweringItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.FLOWERING_EFFECT;
    ...
    public FloweringItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public FloweringItem(){
