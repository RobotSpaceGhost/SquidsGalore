...
public class BeardOilItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.BEARD_OIL_EFFECT;
    ...
    public BeardOilItem(int variant){
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(ITextComponent.func_241827_a_(TextFormatting.GRAY +"For external use only" ));
    }
}
