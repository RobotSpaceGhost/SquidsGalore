...
public class DilutedHoneyItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.DILUTED_HONEY_EFFECT;
    ...
    public DilutedHoneyItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public DilutedHoneyItem(){
