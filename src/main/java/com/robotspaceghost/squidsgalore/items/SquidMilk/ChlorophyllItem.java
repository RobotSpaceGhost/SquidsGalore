...
public class ChlorophyllItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.CHLOROPHYLL_EFFECT;
    ...
    public ChlorophyllItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public ChlorophyllItem(){
