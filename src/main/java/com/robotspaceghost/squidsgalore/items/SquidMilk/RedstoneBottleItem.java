...
public class RedstoneBottleItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.REDSTONE_BOTTLE_EFFECT;
    ...
    public RedstoneBottleItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public RedstoneBottleItem(){
