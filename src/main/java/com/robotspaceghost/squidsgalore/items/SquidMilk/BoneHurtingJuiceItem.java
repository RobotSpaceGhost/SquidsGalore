...
public class BoneHurtingJuiceItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.BONE_HURTING_JUICE_EFFECT;
    ...
    public BoneHurtingJuiceItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public BoneHurtingJuiceItem(){
