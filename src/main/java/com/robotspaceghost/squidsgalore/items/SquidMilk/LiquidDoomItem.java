...
public class LiquidDoomItem extends AbstractMilkItem{
    public final Effect MILK_EFFECT = ModEffects.LIQUID_DOOM_EFFECT;
    ...
    public LiquidDoomItem(int variant){
        super(new Properties().maxStackSize(1));
        this.isLong = variant == 1;
        this.isThick = variant == 2;
    }
    public LiquidDoomItem(){
