...
public class ModSpecialPotions {
    ...
    public static Potion SLIME_BOTTLE_POTION = new Potion(new EffectInstance(ModEffects.SLIME_BOTTLE_EFFECT, ModItems.SLIME_BOTTLE.get().MILK_EFFECT_DURATION)).setRegistryName(location("slime_bottle_effect"));
