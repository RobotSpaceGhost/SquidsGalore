...
public class ModSpecialPotions {
    ...
    */
    ...
    public static Potion INVISIBLE_INK_POTION = new Potion(new EffectInstance(ModEffects.INVISIBLE_INK_EFFECT, ModItems.INVISIBLE_INK.get().MILK_EFFECT_DURATION - 1)).setRegistryName(location("invisible_ink_effect"));
