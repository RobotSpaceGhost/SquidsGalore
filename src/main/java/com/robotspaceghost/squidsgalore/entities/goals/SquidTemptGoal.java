package com.robotspaceghost.squidsgalore.entities.goals;
...
public class SquidTemptGoal extends Goal {
    ...
    protected final ModWaterSquidEntity creature;
    ...
    public SquidTemptGoal(ModWaterSquidEntity creatureIn, double speedIn, Ingredient temptItemsIn) {
        this.creature = creatureIn;
        this.speed = speedIn;
        this.temptItem = temptItemsIn;
        this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        if (!(creatureIn.getNavigator() instanceof SwimmerPathNavigator) && !(creatureIn.getNavigator() instanceof FlyingPathNavigator)) {
            System.out.println(creatureIn.getNavigator().getClass().getName());
            throw new IllegalArgumentException("Unsupported mob type for SquidTemptGoal");
        }
    }
