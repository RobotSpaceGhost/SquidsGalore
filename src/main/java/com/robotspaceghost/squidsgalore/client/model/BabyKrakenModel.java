...
public class BabyKrakenModel<T extends BabyKrakenEntity> extends EntityModel<T> {
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (!entityIn.isSitting()) {
            ...
            this.indexTentacleRight.rotateAngleY += indexTentacleSwingY;
        ...
        }else if (entityIn.isAlive() && entityIn.isSitting() && !entityIn.isInWater()){
            this.indexTentacleRight.rotateAngleY = 0;
            this.indexTentacleRight.rotateAngleZ = 0;
            this.indexTentacleLeft.rotateAngleY = 0;
            this.indexTentacleLeft.rotateAngleZ = 0;
            this.middleTentacleRight.rotateAngleY = 0;
            this.middleTentacleRight.rotateAngleZ = 0;
            this.middleTentacleLeft.rotateAngleY = 0;
            this.middleTentacleLeft.rotateAngleZ = 0;
            this.ringTentacleRight.rotateAngleY = 0;
            this.ringTentacleRight.rotateAngleZ = 0;
            this.ringTentacleLeft.rotateAngleY = 0;
            this.ringTentacleLeft.rotateAngleZ = 0;
            this.pinkieTentacleRight.rotateAngleY = 0;
            this.pinkieTentacleRight.rotateAngleZ = 0;
            this.pinkieTentacleLeft.rotateAngleY = 0;
